...
contract DigitalAssetSupportToken is ERC20 {
    ...
    string public constant name = "DigitalAssetSupportToken";
    string public constant symbol = "DAST";
